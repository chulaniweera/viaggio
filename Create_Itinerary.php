...
function validateDDATE(){
    ...
    adate = new Date(arrival.value);
    ddate = new Date(departure.value);
    d1 = adate.getTime();
    d2 = ddate.getTime();
    if(d1 >= d2){
        alert("Invalid Date");
                    ...
                    <div class="panel panel-primary"> 
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="date" class="form-control" id="arrival_date" onchange="validateADATE();" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="departure date">Departure Date</label>
                                <div class="col-sm-3">
                                    <input type="date" class="form-control" id="departure_date" onchange="validateDDATE();" required>
                                </div>
                            </div>
                            <div class="form-group">
